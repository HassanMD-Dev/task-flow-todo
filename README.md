...
- **Interactive UI:** Tasks ko "Mark as Done" karne ke liye click toggle aur delete karne ke liye smooth interface.
- **Responsive Design:** Mobile aur Desktop dono par behtareen chalti hai.
- **Clear All:** Ek hi click mein poori list saaf karne ki sahulat.

## 🛠️ Tech Stack

- **HTML5:** Semantic structure ke liye.
- **CSS3:** Modern UI aur smooth transitions ke liye.
- **JavaScript (ES6):** Logic, Event Listeners, aur LocalStorage API ke liye.

## 🚀 How to Use

1. **Add Task:** Input box mein apna kaam likhein aur 'Add' dabayein ya 'Enter' press karein.
2. **Mark Complete:** Task ke text par click karein taake wo 'Checked' ho jaye.
